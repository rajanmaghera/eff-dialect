...
mlirGetDialectPluginInfo() {
  return {MLIR_PLUGIN_API_VERSION, "Eff", LLVM_VERSION_STRING,
          [](DialectRegistry *registry) {
            registry->insert<mlir::eff::EffDialect>();
            mlir::eff::registerPasses();
          }};
}
...
extern "C" LLVM_ATTRIBUTE_WEAK PassPluginLibraryInfo mlirGetPassPluginInfo() {
  return {MLIR_PLUGIN_API_VERSION, "EffPasses", LLVM_VERSION_STRING,
          []() { mlir::eff::registerPasses(); }};
}
